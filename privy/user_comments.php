...
?>
   ...
   <form action="" method="POST">
      ...
      <textarea name="comment_edit_box" required cols="30" rows="10" placeholder="Enter comment"><?= $fetch_edit_comment['comment']; ?></textarea>
...
<section class="comments-container">
   ...
   <p class="comment-title">Your comments</p>
